...
/**
 * is_chain - test if the current character in buffer is a chain delimiter
...
/**
 * replace_vars – it replace varaibles in the tokenized string
 * @info: the parameter structure
 *
 * Return: 1 if replaced, 0 otherwise
 */
 ...
 * @old: it address of the old string
 * @new: the new string
 *
 * Return: 1 if replaced, 0 otherwise
 */
